...
individually. PyTorch's `loss.backward()` does this
...
[*Backpropagation, intuitively*](https://www.youtube.com/watch?v=Ilg3gGewQ5U) (3Blue1Brown, Deep Learning ch. 3): the same chain-rule idea as above, built up visually one layer at a time. (Chapter 1, [*But what is a neural network?*](https://www.youtube.com/watch?v=aircAruvnKk), is embedded on Day 6.)
...
[*Backpropagation calculus*](https://www.youtube.com/watch?v=tIeHLnjs5U8) (3Blue1Brown, Deep Learning ch. 4): the full chain-rule mechanics for a general multi-layer network, the general case of the worked example above:

```{=html}
<div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;max-width:100%;margin-bottom:1em;">
<iframe src="https://www.youtube.com/embed/tIeHLnjs5U8" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;" allowfullscreen title="Backpropagation calculus, 3Blue1Brown"></iframe>
</div>
```
...
cross-entropy is built from it: $H(P, Q) = H(P) +
...
[*But what is cross-entropy?*](https://www.youtube.com/watch?v=GlYgs6v2YfU) (3Blue1Brown, Compression is Intelligence part 2): cross-entropy from the information-theory side, built up from first principles:

```{=html}
<div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;max-width:100%;margin-bottom:1em;">
<iframe src="https://www.youtube.com/embed/GlYgs6v2YfU" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;" allowfullscreen title="But what is cross-entropy?, 3Blue1Brown"></iframe>
</div>
```
...
a $(0, 1)$ probability is what is needed. ReLU never shrinks the
...
what Day 10's convolutional network does: 19,237 weights instead
of 192,389.
