...
A short, genuinely by-hand exercise: fill in a small Needleman-Wunsch
dynamic-programming matrix and trace back the optimal alignment
yourself, on paper — this time using a real substitution matrix
(BLOSUM62) instead of the teaching notebook's flat identity scheme, on
two real protein fragments not used anywhere else on this page. A
self-check notebook —
...
verifies your work cell by cell once you have an answer, rather than
computing it for you. Once your matrix and traceback both check out,
answer the Day 4 lab quiz on Canvas using your own results.
