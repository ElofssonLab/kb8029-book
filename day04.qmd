...
*(Further reading: Wikipedia's [Sequence homology](https://en.wikipedia.org/wiki/Sequence_homology)
article covers orthology, paralogy, and the other relatedness terms in
more depth than needed here.)*
...
*(Further reading: Wikipedia's [Dot plot (bioinformatics)](https://en.wikipedia.org/wiki/Dot_plot_(bioinformatics))
article covers filtering/windowing techniques for noisy real sequences,
beyond the simple version above.)*
...
*(Further reading: Wikipedia's [Needleman–Wunsch algorithm](https://en.wikipedia.org/wiki/Needleman%E2%80%93Wunsch_algorithm)
and [Smith–Waterman algorithm](https://en.wikipedia.org/wiki/Smith%E2%80%93Waterman_algorithm)
articles include pseudocode and complexity analysis beyond what's needed
here.)*
...
*(Further reading: Wikipedia's [Point accepted mutation](https://en.wikipedia.org/wiki/Point_accepted_mutation)
and [BLOSUM](https://en.wikipedia.org/wiki/BLOSUM) articles give the full
derivation of each matrix family, beyond the conceptual level above.)*
...
own — the **E-value** — built on exactly this kind of reasoning about
what you'd expect to see by chance.

*(Further reading: Wikipedia's [Standard score](https://en.wikipedia.org/wiki/Standard_score)
and [Kullback–Leibler divergence](https://en.wikipedia.org/wiki/Kullback%E2%80%93Leibler_divergence)
articles cover both concepts in their general statistical form, beyond
...
*(Further reading: Wikipedia's [Multiple sequence alignment](https://en.wikipedia.org/wiki/Multiple_sequence_alignment)
article covers additional methods and applications, e.g. profile HMMs,
which Day 6 picks up in full.)*
